...
class CompleteTokenWorkflowE2ETest extends TestCase
{
    ...
    public function complete_workflow_login_create_copy_token_and_post_exception(): void
    {
        ...
        $service    = app(\Stopit\src\Providers\Services\ApplicationService::class);
        $createData = new \Stopit\src\Providers\src\DTOs\ApplicationData();
         ...
         */
        $exception = \Stopit\src\Providers\Models\ExceptionRecord::where('application_id', $application->id)->first();
