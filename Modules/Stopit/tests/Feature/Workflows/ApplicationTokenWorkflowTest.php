...
class ApplicationTokenWorkflowTest extends TestCase
{
    ...
    public function complete_workflow_from_login_to_posting_exception(): void
    {
         ...
         */
        $applicationData = new \Stopit\src\Providers\src\DTOs\ApplicationData();
    ...
    public function token_belongs_to_specific_application_and_account(): void
    {
        ...
        $app1Data = new \Stopit\src\Providers\src\DTOs\ApplicationData();
        ...
        $app2Data = new \Stopit\src\Providers\src\DTOs\ApplicationData();
    ...
    public function user_can_only_see_applications_from_their_accounts(): void
    {
        ...
        $this->actingAs($this->user);
        $appData = new \Stopit\src\Providers\src\DTOs\ApplicationData();
        ...
        $otherAppData = new \Stopit\src\Providers\src\DTOs\ApplicationData();
    ...
    public function application_name_and_slug_are_required(): void
    {
        ...
        // Test missing name
        $data1 = new \Stopit\src\Providers\src\DTOs\ApplicationData();
    ...
    public function posted_exceptions_increment_occurrence_count_for_duplicates(): void
    {
        ...
        $exception = \Stopit\src\Providers\Models\ExceptionRecord::first();
